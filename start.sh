export PUBLIC_HOSTNAME=`curl http://169.254.170.2/v2/metadata --max-time 3 | jq -r ".Containers[0].Networks[0].IPv4Addresses[0]"`
...
REPLACE_OS_VARS=true bin/macaroni start
